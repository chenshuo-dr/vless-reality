...
# Xray官方脚本 安装 Xray v25.10.15 版本
echo
echo -e "${yellow}官方脚本安装 Xray v25.10.15 版本$none"
echo "----------------------------------------------------------------"
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install --version 25.10.15
...
if [[ -z $domain ]]; then
  ...
  [ -z "$domain" ] && domain="omnirouters.com"
